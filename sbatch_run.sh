...
#SBATCH --job-name=exp64            # Descriptive job name
#SBATCH --time=20:30:00                       # Maximum wall time (hh:mm:ss)
...
#SBATCH --output=logs/exp64.out              # File for standard output
#SBATCH --error=logs/exp64.err               # File for standard error
