...
#SBATCH --job-name=exp33             # Descriptive job name
...
#SBATCH --output=logs/exp33.out              # File for standard output
#SBATCH --error=logs/exp33.err               # File for standard error
